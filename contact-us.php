          ...
          <div class="contact-us-content">
                      <div class="contact-us-info">
                        <div class="each-contact-info">
                          <i class="fa fa-phone"></i><span>شماره تماس: </span><a href="tel:<?php echo get_option(
                            "phone_number",
                          ); ?>"  ><?php echo get_option("phone_number"); ?></a>
                        </div>
                        <div class="each-contact-info">
                          <i class="fa fa-envelope"></i><span>ایمیل: </span><a href="mailto:<?php echo get_option(
                            "email",
                          ); ?>"
                            ><?php echo get_option("email"); ?></a>
                        </div>
                        <div class="each-contact-info">
                          <i class="fa fa-map-marker"></i><span>آدرس: </span><a href="#"><?php echo get_option(
                            "address",
                          ); ?></a>
                        </div>
