            ...
            <?php foreach ($orders as $order):
              ...
              <article class="order-card">
                <div class="order-head">
                  ...
                  <div class="order-status"><?php echo esc_html(
                    $status,
                  ); ?></div>
                </div>
                ...
                <div class="order-body">
                  <ul class="order-items">
                    <?php foreach ($items as $item):
                      ...
                      ?>
                      <li><?php echo esc_html($name); ?> × <?php echo esc_html(
   $qty,
 ); ?></li>
                    <?php
                    endforeach; ?>
                ...
                <div class="order-foot">
                  <div class="order-total"><?php echo wp_kses_post(
                    $total,
                  ); ?></div>
                  <a class="order-view" href="<?php echo esc_url(
                    wc_get_endpoint_url(
                      "view-order",
                      $order_id,
      ...
      echo '<p>برای مشاهده سفارش‌ها ابتدا <a href="' .
