...
?>
  ...
  <div class="cart-container">
    ...
    <?php else : ?>
        ...
        <button type="submit" class="button update-cart" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>" disabled><?php esc_html_e( 'بروزرسانی سبد خرید', 'woocommerce' ); ?></button>
